...
class ModelWrapper:
	def __init__(self, model, model_type: ModelType, task: TaskType, X_valid: pd.DataFrame, y_valid: pd.Series):
		self.model = model
	...
	def plot_importance(
		...
		else: raise ValueError(f'{self.model_type} plot_importance is not supported')
